...
// 重构重复代码
#define CON_TEST_P1(con1, con2, fun, arg, len1, len2, len3) \
  TEST_LEN(len1, len2, len3, WIDE);                         \
  std::cout << "|         std         |";                   \
  FUN_TEST_FORMAT1(std::con1, fun, arg, len1);              \
  FUN_TEST_FORMAT1(std::con1, fun, arg, len2);              \
  FUN_TEST_FORMAT1(std::con1, fun, arg, len3);              \
  std::cout << "\n|        mystl        |";                 \
  FUN_TEST_FORMAT1(mystl::con2, fun, arg, len1);            \
